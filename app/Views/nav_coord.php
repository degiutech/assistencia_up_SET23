...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="<?= URL ?>/coordenacao">HOME</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?= URL ?>/assistencias/filtro_minha_coordenadoria">Gerenciamento</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?= URL ?>/users/create">Novo Assessor</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>/coordenacao/all_representantes">Todos os Assessores</a></li>
                    </ul>
                </li>
...
<div class="container">
    <h1>Coordenadoria</h1>
    <hr>
    <h3 class="cor-texto"><b><?= $user['nome_coordenadoria'] ?></b></h3>
</div>
