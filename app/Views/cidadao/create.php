<div class="col-12 col-xl-8 col-md-10 mx-auto mt-5">
    ...
    <div class="row mb-2">
        ...
        <div class="d-flex justify-content-end col-md-6">
            ...
            <?php } ?>
            <a href="<?= URL ?>/cidadao/cadastros_recentes" class="btn btn-secondary">Cidadãos</a>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" name="registrar" action="<?= URL ?>/cidadao/create">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-3 mb-3">
                        ...
                        <input type="text" name="cpf" id="cpf" value="<?= $dados['cpf'] ?>" class="cpf form-control <?= $dados['cpf_erro'] != '' ? 'is-invalid' : '' ?>" data-mask="000.000.000-00" maxlength="14"  required>
                    ...
                    <div class="col-md-4 col-sm-7 mb-3">
                        ...
                        <input type="text" name="rg" id="rg" value="<?= $dados['rg'] ?>" class="form-control <?= $dados['rg_erro'] != '' ? 'is-invalid' : '' ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="14" placeholder="somente números">
                        <div class="invalid-feedback">
                            <?= $dados['rg_erro'] ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-2 mb-3">
                        ...
                        <input type="text" name="orgao_expedidor" id="orgao_expedidor" value="<?= $dados['orgao_expedidor'] ?>" maxlength="10" class="form-control <?= $dados['orgao_expedidor_erro'] != '' ? 'is-invalid' : '' ?>">
                        <div class="invalid-feedback">
