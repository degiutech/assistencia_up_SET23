    ...
    <div class="card mb-3 mt-3">
        <div class="card-body">
            ...
            <div class="mb-3 mt-3">
                ...
                <?php } else { ?>
                    <a href="<?= URL ?>/coordenacao/coordenadoria/<?= $dados['id_coordenadoria'] ?>/recentes" class="btn btn-outline-secondary">Recentes</a>
                <?php } ?>
                ...
                <?php } else { ?>
                    <a href="<?= URL ?>/coordenacao/coordenadoria/<?= $dados['id_coordenadoria'] ?>/nao_finalizadas" class="btn btn-outline-secondary">Não Finalizadas</a>
                <?php } ?>
                ...
                <?php } else { ?>
                    <a href="<?= URL ?>/coordenacao/coordenadoria/<?= $dados['id_coordenadoria'] ?>/finalizadas" class="btn btn-outline-secondary">Finalizadas</a>
                <?php } ?>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/coordenacao/coordenadoria/<?= $dados['id_coordenadoria'] ?>/data" method="post">
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/coordenacao/coordenadoria/<?= $dados['id_coordenadoria'] ?>/mes_ano" method="post">
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/coordenacao/coordenadoria/<?= $dados['id_coordenadoria'] ?>/periodo" method="post">
