                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mt-2">
                    ...
                    <li class="nav-item">
                        ...
                        <?php if ($dados['titulo_botao'] == 'recentes') { ?>
                            <a href="<?= URL ?>/coordenacao/assistencias" class="btn btn-secondary d-block">Recentes</a>
                        <?php } else { ?>
                            <a href="<?= URL ?>/coordenacao/assistencias" class="btn btn-outline-secondary d-block">Recentes</a>
                        <?php } ?>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <?php if ($dados['titulo_botao'] == 'não finalizadas') { ?>
                            <a href="<?= URL ?>/coordenacao/assistencias_nao_finalizadas" class="btn btn-secondary d-block">Não Finalizadas</a>
                        <?php } else { ?>
                            <a href="<?= URL ?>/coordenacao/assistencias_nao_finalizadas" class="btn btn-outline-secondary d-block">Não Finalizadas</a>
                        <?php } ?>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <?php if ($dados['titulo_botao'] == 'finalizadas') { ?>
                            <a href="<?= URL ?>/coordenacao/assistencias_finalizadas" class="btn btn-secondary d-block">Finalizadas</a>
                        <?php } else { ?>
                            <a href="<?= URL ?>/coordenacao/assistencias_finalizadas" class="btn btn-outline-secondary d-block">Finalizadas</a>
                        <?php } ?>
                    </li>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/coordenacao/ass_por_data" method="post">
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/coordenacao/ass_mes_ano" method="post">
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/coordenacao/ass_periodo" method="post">
