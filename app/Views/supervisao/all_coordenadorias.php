    ...
    <div class="row mb-1">
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-auto">
                    <a href="<?= URL ?>/supervisao/create_coordenadoria" class="btn btn-outline-secondary btn-sm">Nova</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 d-flex justify-content-end align-items-end">
            ...
            <?php } ?>
            <a href="<?= URL ?>/supervisao/all_coordenadores" class="btn btn-secondary">Coordenadores</a>
        </div>
    </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php foreach ($dados['coordenadorias'] as $coordenadoria) { ?>
                            <tr>
                                <td><a href="<?= URL ?>/supervisao/coordenadoria/<?= $coordenadoria['id_coordenadoria'] ?>/recentes" style="text-decoration: none;"><?= $coordenadoria['nome_coordenadoria'] ?></a></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?= URL ?>/supervisao/edit_coordenadoria/<?= $coordenadoria['id_coordenadoria'] ?>" title="Editar">
