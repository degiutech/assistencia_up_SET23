<div class="col-12 col-xl-6 col-md-10 mx-auto mt-5">
    ...
    <h3>Cadastro de Operador(a) do Sistema</h3>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" name="registrar" action="<?= URL ?>/dgassistencia/create_operador">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="password" name="pass" id="pass" value="<?= $dados['pass'] ?>" class="form-control <?= $dados['pass_erro'] != '' ? 'is-invalid' : '' ?>" required>
                        <div class="invalid-feedback">
                            <?= $dados['pass_erro'] ?>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="password" name="pass_confirm" id="pass_confirm" value="<?= $dados['pass_confirm'] ?>" class="form-control <?= $dados['pass_confirm_erro'] != '' ? 'is-invalid' : '' ?>" required>
                        <div class="invalid-feedback">
                ...
                <!--        <select class="form-select" name="acesso" aria-label="Default select example">-->
                <!--            <option value="Administração" selected>Administração</option>-->
                <!--            <option value="Supervisão">Supervisão</option>-->
                <!--            <option value="Coordenadoria">Coordenação</option>-->
                <!--            <option value="Representante">Assessoria</option>-->
                ...
                <!--    <div class="mb-3 col-md-6">-->
                <!--        <label for="email">Bloqueio:</label>-->
                <!--        <select class="form-select" name="bloqueio" aria-label="Default select example">-->
