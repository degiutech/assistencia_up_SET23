...
<div class="esconder_para_print container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?= URL ?>/assistencias/filtro_meus_registros_ass" method="post">

            <!-- inputs invisiveis -->
            <input type="hidden" name="input_datas" id="input_datas" value="<?= $dados['input_datas'] ?>">
            <input type="hidden" name="tipo_busca" class="tipo_busca" value="meus_registros_ass">
    ...
    ?>
        <div class="card mt-3 mb-3">
            <div class="card-body">
                ...
                <b><?= $dados['titulo'] ?></b>
                <div><b class="cor-texto">Operador(a): <?= $dados['nome_operador'] ?></b></div>
