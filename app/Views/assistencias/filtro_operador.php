<div class="esconder_para_print container">
    ...
    <div class="row mb-1">
        <div class="col-md-6">
            <h3 class="mt-4">Assistências por Operador</h3>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?= URL ?>/assistencias/filtro_operador" method="post">

            <!-- inputs invisiveis -->
            <input type="hidden" name="input_datas" id="input_datas" value="<?= $dados['input_datas'] ?>">
            <input type="hidden" name="tipo_busca" class="tipo_busca" value="operador">

                <div class="row">

                    <!-- operadores -->
                    <div class="col-auto">
                        <label for="select_operador" class="form-label">Selecione o Operador</label>

                        <select class="form-select <?= $dados['select_operador_erro'] != '' ? 'is-invalid' : '' ?>" name="select_operador" aria-label="Default select example0">
                            <option value="0" selected>Selecione</option>

                            <?php 
                            if ($dados['operadores'] != '') {
                                foreach ($dados['operadores'] as $op) { ?>
                                    <option value="<?= $op['id'] ?>" <?= $dados['select_operador'] == $op['id'] ? 'selected' : '' ?>><?= $op['nome'] ?></option>;
                            <?php }
                            } ?>

                        </select>
                        <div class="invalid-feedback">
                            <?= $dados['select_operador_erro'] ?>
                        </div>
                    </div>
    ...
    ?>
        <div class="card mt-3 mb-3">
            <div class="card-body">
                ...
                <h5><b class="cor-texto">Operador: <?= $dados['nome_operador'] ?></b></h5>
