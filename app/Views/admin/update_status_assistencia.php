    ...
    <div class="card">
        <div class="card-body">
            ...
            ?>
                ...
                <form method="post" name="registrar" action="<?= URL ?>/admin/update_status_assistencia/<?= $dados['id_assistencia'] ?>/<?= $status_ass ?>">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="novo_status" id="novo_status" class="form-select <?= $dados['novo_status_erro'] ? 'is-invalid' : '' ?>">

                                <option value="Selecione">Selecione</option>
                                <option value="Em andamento" <?= ($dados['status_atual'] == 'Em andamento') ? 'selected' : '' ?>>Em andamento</option>
