<div class="container">
        ...
        <div class="container-fluid p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mt-2">
                    ...
                    <li class="nav-item">
                        ...
                        <?php if ($dados['titulo_botao'] == 'recentes') { ?>
                            <a href="<?= URL ?>/admin/assistencias" class="btn btn-secondary d-block">Recentes</a>
                        <?php } else { ?>
                            <a href="<?= URL ?>/admin/assistencias" class="btn btn-outline-secondary d-block">Recentes</a>
                        <?php } ?>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <?php if ($dados['titulo_botao'] == 'não finalizadas') { ?>
                            <a href="<?= URL ?>/admin/assistencias_nao_finalizadas" class="btn btn-secondary d-block">Não Finalizadas</a>
                        <?php } else { ?>
                            <a href="<?= URL ?>/admin/assistencias_nao_finalizadas" class="btn btn-outline-secondary d-block">Não Finalizadas</a>
                        <?php } ?>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <?php if ($dados['titulo_botao'] == 'finalizadas') { ?>
                            <a href="<?= URL ?>/admin/assistencias_finalizadas" class="btn btn-secondary d-block">Finalizadas</a>
                        <?php } else { ?>
                            <a href="<?= URL ?>/admin/assistencias_finalizadas" class="btn btn-outline-secondary d-block">Finalizadas</a>
                        <?php } ?>
                    </li>
                ...
                <div class="d-flex d-none d-lg-block">
                    ...
                    <a href="<?= URL ?>/cidadao/cadastros_recentes" class="btn btn-primary" style="float:right;">Cidadãos</a>

                    <?php if (isset($dados['home'])) { ?>
                        <a href="<?= $dados['home'] ?>" class="btn btn-primary btn-block" style="float:right;">HOME</a>
                    <?php } ?>
    ...
    <!-- Assistências -->
    <div class="card" id="div_registros">
        <div class="card-body">
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/admin/ass_por_data" method="post">
                    <div class="modal-body">
                        <input type="date" name="por_data" id="input_por_data" class="form-control mb-3">

                        <!-- <div class="form-check">
                            <input class="form-check-input" type="radio" name="status_assistencia" id="status_assistencia1" value="nao_finalizadas">
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/admin/ass_mes_ano" method="post">
                    ...
                    <input type="date" name="mes" id="input_mes" class="form-control"> -->
                        ...
                        <!-- <div class="form-check">
                            <input class="form-check-input" type="radio" name="status_assistencia" id="status_mes_ano1" value="nao_finalizadas">
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/admin/ass_periodo" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- <div class="form-check">
                            <input class="form-check-input" type="radio" name="status_assistencia" id="status_periodo1" value="nao_finalizadas">
