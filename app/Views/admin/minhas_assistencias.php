<div class="container">
    ...
    <div class="row mb-1">
        <div class="col-md-6">
            ...
            <h3 class="mt-4">Meus Registros de Assistências</h3>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mt-2">
                    ...
                    <li class="nav-item">
                        ...
                        <?php if ($dados['titulo_botao'] == 'recentes') { ?>
                            <a href="<?= URL ?>/admin/minhas_assistencias" class="btn btn-secondary d-block">Recentes</a>
                        <?php } else { ?>
                            <a href="<?= URL ?>/admin/minhas_assistencias" class="btn btn-outline-secondary d-block">Recentes</a>
                        <?php } ?>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <?php if ($dados['titulo_botao'] == 'não finalizadas') { ?>
                            <a href="<?= URL ?>/admin/minhas_ass_nao_finalizadas" class="btn btn-secondary d-block">Não Finalizadas</a>
                        <?php } else { ?>
                            <a href="<?= URL ?>/admin/minhas_ass_nao_finalizadas" class="btn btn-outline-secondary d-block">Não Finalizadas</a>
                        <?php } ?>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <?php if ($dados['titulo_botao'] == 'finalizadas') { ?>
                            <a href="<?= URL ?>/admin/minhas_ass_finalizadas" class="btn btn-secondary d-block">Finalizadas</a>
                        <?php } else { ?>
                            <a href="<?= URL ?>/admin/minhas_ass_finalizadas" class="btn btn-outline-secondary d-block">Finalizadas</a>
                        <?php } ?>
                    </li>
    ...
    <div class="card" id="div_relatorio" style="display: none;">
        <div class="card-body">
            ...
            <table class="table table-sm table-bordered mt-3">
                <thead>
                    <tr>
                        <th scope="col">1º registro</th>
                        <th scope="col">Descrição 1º registro</th>
                        <th scope="col">Última atualização</th>
                        <th scope="col">Desc. última atualização</th>
                ...
                <tbody>
                    ...
                    ?>
                                ...
                                <tr>
                                    <th scope="row"><?= $ass['data_primeiro_registro'] ?></th>
                                    <td style="width: 25%"><?= $ass['descricao'] ?> - <?= $ass['desc_comp_primeiro_reg'] ?></td>
                                    <td><?= $ass['data'] ?></td>
                                    <td><?= $ass['status_compl_updated'] ?></td>
                                    <td><?= $ass['status_assist'] ?></td>
                                    <td><a href="<?= URL ?>/assistencias/assistencia/<?= $ass['id_primeiro_registro'] ?>"><i class="bi bi-list-task" title="Histórico"></i></a></td>
                                </tr>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/admin/minhas_ass_por_data" method="post">
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/admin/minhas_ass_mes_ano" method="post">
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Formulário -->
                <form action="<?= URL ?>/admin/minhas_ass_periodo" method="post">
