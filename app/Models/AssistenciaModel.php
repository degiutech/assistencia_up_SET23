...
class AssistenciaModel
{
    ...
    public function filtrosAssistenciasByOperador($dados)
    {
        ...
        if ($dados['input_datas'] == 'data') {
            $query = "SELECT * FROM assistencias WHERE id_created_by='$id_operador' AND date_at='$data' ORDER BY created_at DESC LIMIT 200";
        }
        if ($dados['input_datas'] == 'mes_ano') {
            $query = "SELECT * FROM assistencias WHERE id_created_by='$id_operador' AND MONTH(date_at)='$mes' AND YEAR(date_at) ='$ano' ORDER BY created_at DESC LIMIT 200";
        }
        if ($dados['input_datas'] == 'periodo') {
            $query = "SELECT * FROM assistencias WHERE id_created_by='$id_operador' AND date(date_at) >= '$dt_inicial' AND date(date_at) <= '$dt_final' ORDER BY created_at DESC LIMIT 200";
        }
    ...
    // XXXXXXXXXXXXXXXXXXXXXXXX FIM DE MAIS FILTROS XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
